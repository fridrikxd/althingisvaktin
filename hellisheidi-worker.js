...
const HELLISHEIDI_ROUTE = [
  ...
  {
    key: "threngslavegur-fossvellir",
    roadIdPrefix: 90201,
    label: "Hringvegur: Þrengslavegur - Fossvellir",
    fallbackName: "Hringvegur: Þrengslavegur - Fossvellir"
  }
];

const MAIN_HEATH_KEYS = new Set(["hellisheidi-westbound", "hellisheidi-eastbound"]);
const THRENGSLI_KEY = "threngslavegur-fossvellir";
...
export default {
  async fetch(request) {
    ...
    return respond({ ok: false, error: "Notaðu: /, /app.js, /status" });
  }
};
